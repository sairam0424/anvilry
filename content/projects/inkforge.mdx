...
license: MIT
relatedArticles: [inkforge-build-devto]
...
decisions:
  - title: "Bedrock's fallback stops at Haiku 4.5 and skips Opus 4.6"
  ...
  - title: "I kept Hashnode's client despite its now-decommissioned API"
