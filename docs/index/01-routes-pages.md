...
| `src/app/mcp/page.tsx` | `/mcp` — MCP server docs: endpoint, Claude Desktop + Cursor JSON configs, **9**-row tool table (all 9 registered; was 7 — see FIXED note in Detail) | `metadata`, default `McpPage` |
