...
| `react-markdown` | `^10.1.0` | prod | Renders assistant text as a React vdom (never `dangerouslySetInnerHTML`) | `src/components/chat/markdown-message.tsx:4,7` — only import site | Client-bundled, itself lazily imported by `ask-portfolio.tsx:18` and `chat-messages.tsx:279` |
