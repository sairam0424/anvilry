...
- **Consumed by:** `src/app/api/tts/route.ts:8`, `src/app/api/tts-google/route.ts:5`, `src/components/command-palette-content.tsx:51`, `src/components/chat/voice-picker.tsx:12`, `src/components/chat/use-speech-synthesis.ts:9`, `src/components/chat/voice-settings-dialog.tsx:18`, `src/components/chat/talk-mode.tsx:21`, `src/lib/voice-settings-context.tsx:4`.
- **Behaviour notes:**
...
- **Consumed by:** `src/components/command-palette-content.tsx:49`, `src/components/chat/chat-messages.tsx:11`, `use-voice-session.ts:7`, `talk-launch-button.tsx:6`, `voice-settings-dialog.tsx:17`, `use-speech-synthesis.ts:14`, `talk-mode.tsx:20`, `wake-word-controller.tsx:6`, `mic-button.tsx:6`.
- **Behaviour notes:**
...
- **Consumed by:** `useMediaQuery` — `src/components/chat/header-orb-trigger.tsx:7`, `chat/voice-orb.tsx:6`, `hero-graph/index.tsx:6`, `game/build-graph.tsx:7`, `hero-avatar/index.tsx:6`. `useWebGLSupported` — `chat/voice-orb.tsx:6`, `game/build-graph.tsx:7`.
