...
(`:50,65,77,93,105,121,137,150,160`); the two tools landed at v3.0.0 (`CHANGELOG.md:397-398` records the
7 → 9 growth) and the docs caught up here (`CHANGELOG.md:62-64`).
