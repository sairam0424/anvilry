...
/** Notes generated by Inkforge — useful for filtering or tagging in the UI. */
export const inkforgeNotes = allNotes.filter((n) => n.generatedBy === "inkforge");

/** Inkforge-generated articles (notes with generatedBy=inkforge, drafts excluded),
 *  newest first. These are the notes that Inkforge writes to content/notes/ and
...
export const hasArticles = allArticles.length > 0;
