...
- **Consumed by:** `src/app/api/tts/route.ts:8`, `src/app/api/tts-google/route.ts:5`, `src/components/command-palette-content.tsx:55`, `src/components/chat/voice-picker.tsx:12`, `src/components/chat/use-speech-synthesis.ts:9`, `src/components/chat/voice-settings-dialog.tsx:18`, `src/components/chat/talk-mode.tsx:21`, `src/lib/voice-settings-context.tsx:4`.
- **Behaviour notes:**
